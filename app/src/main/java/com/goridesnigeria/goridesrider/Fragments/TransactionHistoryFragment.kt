...
import com.goridesnigeria.goridesrider.adapter.TransactionAdapter
import com.goridesnigeria.goridesrider.model.TransactionModel
...
class TransactionHistoryFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tadapter = TransactionAdapter()
        riderecyclerview.adapter = tadapter

        viewModel = ViewModelProvider(this).get(TransactionModel::class.java)
        viewModel._alltransactions.observe(viewLifecycleOwner, Observer {

            tadapter.updateTransactionList(it)
        })
    }
}